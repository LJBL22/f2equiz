  ...
  return (
    <div className="flex flex-row w-auto items-center gap-2">
      ...
      <div
        ...
        className="w-8 h-5 bg-purple rounded-full relative tablet:w-12 tablet:h-7 cursor-pointer"
      >
        <div
          className={`w-3 h-3 tablet:w-5 tablet:h-5 bg-pure-white rounded-full absolute inset-y-1 left-1 transition-transform pointer-events-none ${
            theme === "dark"
